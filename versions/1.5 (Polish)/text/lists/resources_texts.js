...
'Acid Gland (Gorm)': {'label':'Gruczoł kwasowy (Gorm)', 'type': 'organ', 'text': 'Roztapia skórę.<br\><br\><i>Szansa wylosowania: 1/21.</i>'},
'Dense Bone (Gorm)': {'label':'Twarda kość (Gorm)', 'type': 'kość', 'text': 'Solidna.<br\><br\><i>Szansa wylosowania: 2/21.</i>'},
'Gorm Brain (Gorm)': {'label':'Mózg Gorma (Gorm)', 'type': 'organ', 'text': 'Szokująco mały.<br\><br\><i>Szansa wylosowania: 1/21.</i>'},
'Handed Skull (Gorm)': {'label':'Czaszka Gorma (Gorm)', 'type': 'kość', 'text': 'Niezwykle twarda.<br\><br\><i>Szansa wylosowania: 1/21.</i>'},
'Jiggling Lard (Gorm)': {'label':'Falująca słonina (Gorm)', 'type': 'organ/skóra', 'text': 'Gęsta, drżąca masa.<br\><br\><i>Szansa wylosowania: 2/21.</i>'},
'Mammoth Hand (Gorm)': {'label':'Mamucia dłoń (Gorm)', 'type': 'kość/skóra/organ', 'text': 'Ogromna, skórzana rękawica.<br\><br\><i>Szansa wylosowania: 2/21.</i>'},
'Meaty Rib (Gorm)': {'label':'Mięsiste żebro (Gorm)', 'type': 'kość/organ', 'text': 'Przydatne i przepyszne.<br\><br\><i>Szansa wylosowania: 2/21.</i>'},
'Milky Eye (Gorm)': {'label':'Zamglone oko (Gorm)', 'type': 'organ', 'text': 'Kiedy otrzymujesz ten zasób, Ocalały którego wybierzesz otrzymuje +3 obłędu.<br\><br\><i>Szansa wylosowania: 1/21.</i>'},
'Stout Heart (Gorm)': {'label':'Tęgie serce (Gorm)', 'type': 'organ', 'text': 'Gigantyczna pompa.<br\><br\><i>Szansa wylosowania: 2/21.</i>'},
'Stout Hide (Gorm)': {'label':'Tęga skóra (Gorm)', 'type': 'skóra', 'text': 'Twarda, pomarszczona skóra.<br\><br\><i>Szansa wylosowania: 4/21.</i>'},
'Stout Kidney (Gorm)': {'label':'Tęga nerka (Gorm)', 'type': 'organ', 'text': 'Spożycie: zarchiwizuj tę kartę i rzuć 1k10. Przy wyniku 6+, otrzymujesz 10 przetrwania, w przeciwnym wypadku zmniejsz swoje przetrwanie do 0.<br\><br\><i>Szansa wylosowania: 2/21.</i>'},
'Stout Vertebrae (Gorm)': {'label':'Tęgi kręgosłup (Gorm)', 'type': 'kość', 'text': 'Ciężki i misternie złączony.<br\><br\><i>Szansa wylosowania: 1/21.</i>'},
