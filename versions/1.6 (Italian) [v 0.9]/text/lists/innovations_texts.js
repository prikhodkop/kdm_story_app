...
const texts = {
 ...
 'Language': {
  ...
  'passive': {
    ...
    'actions': [
      '<b class="action">Incoraggia</b>: Una volta per round, se non sei atterrato, spendi 1 survival per chiamare un sopravvissuto non sordo. Si erge in piedi se atterrato.',
    ],
  }
 },
 'Lantern Oven': {
