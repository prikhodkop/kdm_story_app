...
'Curious Hand (White Lion)': {'type': 'hide', 'text': '"When you gain this, a random survivor gains +1 insanity. Holding this fills you with sadness."<br\><br\><i>Drop chance: 1/19.</i>'},
'Eye of Cat (White Lion)': {'type': 'organ/consumable', 'text': 'A perfectly preserved eye.<br\><br\><i>Drop chance: 1/19.</i>'},
'Golden Whiskers (White Lion)': {'type': 'organ', 'text': 'These whiskers are tough!<br\><br\><i>Drop chance: 1/19.</i>'},
'Great Cat Bones (White Lion)': {'type': 'bone', 'text': 'Strong and surprisingly light.<br\><br\><i>Drop chance: 4/19.</i>'},
'Lion Claw (White Lion)': {'type': 'bone', 'text': 'A razor-sharp, retractable claw.<br\><br\><i>Drop chance: 3/19.</i>'},
'Lion Tail (White Lion)': {'type': 'hide', 'text': 'It\'s surprisingly heavy.<br\><br\><i>Drop chance: 1/19.</i>'},
'Lion Testes (White Lion)': {'type': 'organ/consumable', 'text': 'A hefty pair of nuts.<br\><br\><i>Drop chance: 1/19.</i>'},
'Shimmering Mane (White Lion)': {'type': 'hide', 'text': 'Archive this to gain 2 basic hide resources. It shimmers in the lantern light.<br\><br\><i>Drop chance: 1/19.</i>'},
'Sinew (White Lion)': {'type': 'organ', 'text': 'These stringy guts are quite useful.<br\><br\><i>Drop chance: 2/19.</i>'},
'White Fur (White Lion)': {'type': 'hide', 'text': 'Luxurious and soft to the touch.<br\><br\><i>Drop chance: 4/19.</i>'},

'??? (Basic)': {'type': 'organ/bone/hide/consumable', 'text': '"You have no idea what monster bit this is. Can be used as a bone, organ, or hide!"<br\><br\><i>Drop chance: 2/21.</i>'},
'Broken Lantern (Basic)': {'type': 'scrap', 'text': 'Remains of an extinguished lantern.<br\><br\><i>Drop chance: 2/21.</i>'},
'Love Juice (Basic)': {'type': 'organ/consumable', 'text': 'During the settlement phase, you may archive this to triggrer Intimacy story event. Nominated survivors must be able to consume.<br\><br\><i>Drop chance: 2/21.</i>'},
'Monster Bone (Basic)': {'type': 'bone', 'text': 'A bone suitable for crafting.<br\><br\><i>Drop chance: 4/21.</i>'},
'Monster Hide (Basic)': {'type': 'hide', 'text': 'The skin of a beast.<br\><br\><i>Drop chance: 7/21.</i>'},
'Monster Organ (Basic)': {'type': 'organ/consumable', 'text': '"If you consume this, archive this card. Roll 1d10. On a result of 6+, you contract a parasite. Archive all consumable gear in your grid now."<br\><br\><i>Drop chance: 3/21.</i>'},
'Skull (Basic)': {'type': 'bone', 'text': 'When you gain this, a survivor of your choice gains +1 insanity.<br\><br\><i>Drop chance: 1/21.</i>'},
...
function get_representation (word) {
  ...
  if (word in glossary_terms) {
    ...
    let result = '<b style="font-size:1.3em;">' + word + '</b><br/><i style="font-size:0.9em;color:#777;">('+resources[word]['type']+')</i> <hr/>' + resources[word]['text']
