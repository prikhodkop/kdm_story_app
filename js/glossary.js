...
var fightning_arts_text = {
   'Abyssal Sadist':{'expansion':'manhunter'},
   'Acrobatics':{'expansion':'dragon king'},
   'Ambidextrous':{},
   'Backstabber':{'expansion':'echoes of death', 'type':'strain'},
   'Berserker':{},
   'Blotted Out':{'expansion':'slenderman'},
   'Burning Ambition':{'expansion':'sunstalker'},
   'Burning Focus':{'expansion':'lion god'},
   'Carapace of Will':{'expansion':'dung beetle knight'},
   'Champions Rite':{'expansion':'dragon king', 'type':'dragon trait'},
   'Clutch Fighter':{},
   'Combo Master':{},
   'Crazed':{},
   'Crossarm Block':{},
   'Defender':{'expansion':'sunstalker'},
   'Double Dash':{},
   'Etheral Pact':{'expansion':'echoes of death', 'type':'strain'},
   'Extra Sense':{},
   'Fated Blow':{'expansion':'dragon king', 'type':'dragon trait'},
   'Giants Blood':{'expansion':'echoes of death', 'type':'strain'},
   'Harvestman':{'expansion':'spidicules'},
   'Headliner':{'expansion':'lion knight'},
   'Heroic':{'expansion':'lion god'},
   'Infinite Lives':{'expansion':'echoes of death', 'type':'strain'},
   'Last Man Standing':{},
   'Leader':{},
   'Lure Epilepsy':{'expansion':'gorm'},
   'Mammoth Hunting':{'expansion':'gorm'},
   'Mighty Strike':{},
   'Monster Claw Style':{},
   'Orator of Death':{},
   'Otherworldly Luck':{'expansion':'flower knight'},
   'Phantom Friend':{'expansion':'slenderman'},
   'Propulsion Drive':{'expansion':'dung beetle knight'},
   'Purpose':{'expansion':'sunstalker'},
   'Rhythm Chaser':{},
   'Ruthless':{'expansion':'lion god'},
   'Seasoned Hunter':{'expansion':'manhunter'},
   'Sneak Attack':{'expansion':'sunstalker'},
   'Strategist':{},
   'Tenacious':{'expansion':'lion knight'},
   'Thrill Seeker':{},
   'Timeless Eye':{},
   'Tough':{},
   'Trailblazer':{'expansion':'manhunter'},
   'Transcended Masochist':{'expansion':'manhunter'},
   'Trick Attack':{'expansion':'sunstalker'},
   'Tumble':{},
   'Unbreakable':{'expansion':'dragon king', 'type':'dragon trait'},
   'Unconscious Fighter':{},
   'Unrelenting':{'expansion':'lion god'},
   'Vengeance':{'expansion':'spidicules'},
   'Wardrobe Expert':{'expansion':'lion knight'}
}
...
var disorders_text = {
  'Absent Seizures':{'expansion':'gorm'},
   'Aichmophobia':{'expansion':'dragon king'},
   'Anxiety':{},
   'Apathetic':{},
   'Arithmophilia':{'expansion':'dragon king'},
   'Binge Eating':{},
   'Controlophobia':{'expansion':'spidicules'},
   'Coprolalia':{},
   'Delicious':{'expansion':'lion god'},
   'Destined':{'expansion':'dragon king', 'type':'dragon trait'},
   'Emotionless':{'expansion':'sunstalker'},
   'Enfeebled':{'expansion':'lion god'},
   'Fear of the Dark':{},
   'Flower Addiction':{'expansion':'flower knight'},
   'Ghostly Beauty':{'expansion':'flower knight'},
   'Hemophobia':{},
   'Hoarder':{},
   'Honorable':{},
   'Hyperactive':{},
   'Immortal':{},
   'Indecision':{},
   'Megalophobia':{'expansion':'gorm'},
   'Monster Panic':{},
   'Motion Sickness':{'expansion':'dung beetle knight'},
   'Narcissistic':{'expansion':'flower knight'},
   'Overprotective':{'expansion':'sunstalker'},
   'Performance Anxiety':{'expansion':'lion knight'},
   'Post-Traumatic Stress':{},
   'Prey':{},
   'Prima Donna':{'expansion':'lion knight'},
   'Quixotic':{},
   'Rageholic':{},
   'Revenge':{'expansion':'spidicules'},
   'Secretive':{},
   'Seizures':{},
   'Shallow Lungs':{'expansion':'lion knight'},
   'Spiral Ganglia':{'expansion':'slenderman'},
   'Squeamish':{},
   'Stage Fright':{'expansion':'lion knight'},
   'Stark Raving':{'expansion':'lion god'},
   'Sun-Drunk':{'expansion':'sunstalker'},
   'Superstitious':{'expansion':'dragon king'},
   'Sworn Enemy':{},
   'Tiny Arachnophobia':{'expansion':'spidicules'},
   'Traumatized':{},
   'Tunnel Vision':{'expansion':'lion god'},
   'Unlucky':{'expansion':'lion knight'},
   'Vermin Obsession':{'expansion':'dung beetle knight'},
   'Vestiphobia':{},
   'Weak Spot':{}
};
...
var secret_fightning_arts_text = {
   ...
   'Acanthus Doctor':{'expansion':'flower knight'},
   'Ageless Apprentice':{'expansion':'lion knight'},
   'Altered Destiny':{'expansion':'dragon king'},
   'Beast of Caratosis':{},
   'Beetle Strength':{'expansion':'dung beetle knight'},
   'Black Guard Style':{'whitebox':'percival'},
   'Bone Whisperer':{},
   'Clarity of Darkness':{'expansion':'slenderman'},
   'Courtly Screenwriter':{'expansion':'lion knight'},
   'Death Touch':{'expansion':'spidicules'},
   'Eternal Will':{'expansion':'manhunter'},
   'Fencing':{'expansion':'flower knight'},
   'Frozen Star':{'expansion':'dragon king', 'type':'dragon trait'},
   'Grace of Dormentaus':{},
   'Hellfire':{'expansion':'sunstalker'},
   'Immovable Object':{'expansion':'gorm'},
   ...
   'Suppressed Shadow':{'expansion':'sunstalker'},
   'Swordsmans Promise':{},
   'Synchronised Strike':{},
   'True Blade':{'expansion':'flower knight'},
   'Zero Prescence':{}
};
...
var settlement_events = {
 ...
 'Nickname':{},
 'Open Maw':{},
 'Phantom':{'expansion':'slenderman'},
 'Plague':{},
 'Rivalry':{},
 'Skull Eater':{},
 'Slender Blight':{'expansion':'slenderman'},
