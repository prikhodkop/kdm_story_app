...
function createReference() {
  ...
  var selectize = $('#reference-window').selectize({
    ...
    optgroups: [
        ...
        {value: 'settlement locations', label: 'Settlement Locations'},
        ...
        {value: 'survivor statuses', label: 'Survivor Statuses'},
        {value: 'armor sets', label: 'Armor Sets'},
