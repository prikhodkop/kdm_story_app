const texts = {
 ...
 'Arrow': 'A gear keyword. This gear card is an arrow. Although arrows require a bow to be in your gear grid to be activated, arrows and bows are distinct weapons. Arrows do not inherit the qualities of bows they are fired from (cumbersome, cursed, etc), except range. Wounding with an arrow does not make a survivor eligible to earn bow proficiency.',
 ...
 'Courage': 'A survivor attribute listed on the survivor record sheet. Courage is a survivor\'s potentially ill-advised bravery. Reaching a courage level of 3 will trigger the <b>Bold</b> Story Event, while reaching a level of 9 will trigger the <b>See the Truth</b> Story Event.',
 ...
 'Dash': 'A survival action. When opportunity permits, a survivor may spend 1 survival to dash. They gain +1 <b>Movement</b> action, which must be spent immediately. Each survivor may only Dash once per round. and only after the settlement has innovated the Paint innovation.',
 ...
 'Deflect X': 'A gear special rule. When you Deflect X, gain (or lose) deflect tokens until you have X of them. When you are hit, if you have any deflect tokens, you ignore that hit and lose a deflect token. When you Deflect X, you lose the benefits of <b>Block</b>.',
 ...
 'Doomed': 'While a survivor is doomed, they cannot perform any actions or spend surival. If a survivor is doomed by a monster\'s AI or Hit Location card, they are doomed until all actions on the card are performed and the card is resolved.',
 ...
 'Outfit': 'A gear keyword. This completes an armor set if you\'re wearing the rest of the set and it shares a material keyword with the missing armor gear. For example, if you\'re wearing an Oxidized Lantern Helm and Phoenix Armor on every other hit location, you would gain the Phoenix Armor Set bonus because the Phoenix Helm also has the metal keyword.',
 ...
 'Reveal': 'Turn a card face up and examine it (Do not play it). Do not reshuffle a deck to reveal more cards than are in the deck.',
